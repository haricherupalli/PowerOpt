...
namespace POWEROPT {
  ...
  typedef vector<GateVector> GateVV;
  typedef GateVV::iterator GateVVItr;

  typedef vector<Grid *> GridVector;
  typedef GridVector::iterator GridVectorItr;

  typedef vector<Pin *> PinVector;
  typedef PinVector::iterator PinVectorItr;

  typedef vector<Path *> PathVector;
  typedef PathVector::iterator PathVectorItr;

  typedef vector<Libcell *> LibcellVector;
  typedef LibcellVector::iterator LibcellVectorItr;

  typedef vector<Divnet *> DivnetVector;
  typedef DivnetVector::iterator DivnetVectorItr;

  typedef vector<Terminal *> TerminalVector;
  typedef TerminalVector::iterator TerminalVectorItr;
  ...
  typedef map<string, double> StrDoubleMap;
  typedef StrDoubleMap::iterator StrDoubleMapItr;
  ...
  typedef CharVector::iterator CharVectorItr;

  typedef vector<string> path_t;
  typedef vector<path_t>   endpoint_pair_t;
  //typedef vector<path_t>   slack_bin_t;
  typedef vector<endpoint_pair_t>  endpoint_pair_list_t;
